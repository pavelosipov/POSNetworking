...
@property (nonatomic, copy, setter=posrx_setUploadProgressHandler:) void (^posrx_uploadProgressHandler)(POSHTTPRequestProgress *progress);
...
@property (nonatomic, copy, setter=posrx_setDownloadProgressHandler:) void (^posrx_downloadProgressHandler)(POSHTTPRequestProgress *progress);
